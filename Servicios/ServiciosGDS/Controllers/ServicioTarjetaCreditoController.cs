...
namespace ServiciosGDS.Controllers
{
    public class ServicioTarjetaCreditoController : BaseController
    {
        ...
        public CE_Response1<bool> RegistroEmisionB2B(CE_Request2<CE_EmisionB2B> request)
        {
        ...
        public CE_Response1<bool> ActualizarInformacionEmisionB2B(CE_Request2<RQ_ActualizacionTarjetaB2B> request)
        {
            var lrespuesta = new CE_Response1<bool>();
            try
            {
        ...
        [HttpPost]
        [ActionName("ActualizarEmisionAnulada")]
        public CE_Response1<bool> ActualizarEmisionAnulada(CE_Request2<CE_EmisionB2B> request)
        {
            var lrespuesta = new CE_Response1<bool>();
            try
            {
                using (var ltarjetaService = new TarjetaCredito(request.Aplicacion.Value, request.CodigoSeguimiento, request.CodigosEntorno))
                {
                    ltarjetaService.Prepare();
                    bool lresultado;
                    lrespuesta.Estatus = ltarjetaService.ActualizarEmisionAnulada(request.Parametros, out lresultado);
                    lrespuesta.Resultado = lresultado;
                }
            }
            catch (Exception ex)
        ...
        public CE_Response1<bool> EliminarInformacionEmisionB2B(CE_Request2<RQ_ActualizacionTarjetaB2B> request)
        {
            var lrespuesta = new CE_Response1<bool>();
            try
            {
        ...
        [HttpPost]
        [ActionName("ObtenerEmisionesB2BXFecha")]
        public CE_Response1<List<CE_EmisionB2B>> ObtenerEmisionesB2BPorFecha(CE_Request2<string[]> request)
        {
            var lrespuesta = new CE_Response1<List<CE_EmisionB2B>>();
            ...
            try
            {
                using (var ltarjetaService = new TarjetaCredito(request.Aplicacion.Value, request.CodigoSeguimiento, request.CodigosEntorno))
                {
                    ltarjetaService.Prepare();
                    List<CE_EmisionB2B> lresultado;
                    lrespuesta.Estatus = ltarjetaService.ObtenerEmisionesB2BPorFecha(request.Parametros, out lresultado);
                    lrespuesta.Resultado = lresultado;
                }
