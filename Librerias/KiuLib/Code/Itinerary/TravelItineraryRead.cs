...
namespace KiuLib.Itinerary
{
    public sealed class TravelItineraryRead : Common<KiuCredential, KiuHeader>
    {
                                   ...
                                   out CE_Reserva reserva)
        {
            ...
            {
                // registrando evento
                Bitacora.Current.Warn(null, ex, new { MuteErrors, pnr, reserva, ltravelItineraryReadRQRequest, ltravelItineraryReadRQResponse, lrespuesta }, CodigoSeguimiento);
            ...
            {
                // registrando evento
                Bitacora.Current.Error(null, ex, new { MuteErrors, pnr, reserva, ltravelItineraryReadRQRequest, ltravelItineraryReadRQResponse, lrespuesta }, CodigoSeguimiento);
