...
namespace SabreLib.AirTicket
{
    public sealed class EnhancedAirTicket : Common<Security, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
                                   ...
                                   out CE_Boleto[] boletos)
        {
            ...
            try
            {
                ...
                lairTicketRQRequest = new AirTicketRQRequest
                {
                    ...
                    AirTicketRQ = new AirTicketRQ
                    {
                        ...
                        PostProcessing = new AirTicketRQPostProcessing
                        {
                            ...
                            actionOnPQExpired = AirTicketRQPostProcessingActionOnPQExpired.Q,
                ...
                using (var lservicio = Configuracion.GetServiceModelClient<AirTicketPortTypeChannel>())
                {
                    ...
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'AirTicketPortTypeChannel.EnhancedAirTicket'", new { lairTicketRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lairTicketRQResponse = lservicio.AirTicketRQ(lairTicketRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'AirTicketPortTypeChannel.EnhancedAirTicket'", new { lairTicketRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.WarnAndInfo(ex, new { MuteErrors, perfilImpresora, reserva, boletos, lairTicketRQRequest, lairTicketRQResponse, lrespuesta }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, perfilImpresora, reserva, boletos, lairTicketRQRequest, lairTicketRQResponse, lrespuesta }, CodigoSeguimiento);
        ...
        /// <param name="boletos"></param>
        /// <returns></returns>
        public CE_Estatus Emitir(string perfilImpresora,
                                 CE_Reserva reserva,
                                 out CE_Boleto[] boletos)
        {
