    ...
    public sealed class AddRemark : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
        ...
        public CE_Estatus Execute(CE_Comentario[] comentarios)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'AddRemarkPortTypeChannel.AddRemarkRQ'", new { laddRemarkRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    laddRemarkRQResponse = lservicio.AddRemarkRQ(laddRemarkRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'AddRemarkPortTypeChannel.AddRemarkRQ'", new { laddRemarkRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, comentarios, laddRemarkRQRequest, laddRemarkRQResponse, lrespuesta }, CodigoSeguimiento);
