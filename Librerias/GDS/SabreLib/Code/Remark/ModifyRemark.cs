    ...
    public class ModifyRemark : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
                                   ...
                                   int[] idsComentarios)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'ModifyRemarkPortTypeChannel.ModifyRemarkRQ'", new { lmodifyRemarkRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lmodifyRemarkRQResponse = lservicio.ModifyRemarkRQ(lmodifyRemarkRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'ModifyRemarkPortTypeChannel.ModifyRemarkRQ'", new { lmodifyRemarkRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, tipoOperacion, comentarios, idsComentarios, lmodifyRemarkRQRequest, lmodifyRemarkRQResponse, lrespuesta }, CodigoSeguimiento);
