    ...
    public sealed class QueueAccess : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
                                                     ...
                                                     bool lista)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'QueueAccessPortTypeChannel.QueueAccessRQ'", new { lqueueAccessRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lqueueAccessRQResponse = lservicio.QueueAccessRQ(lqueueAccessRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'QueueAccessPortTypeChannel.QueueAccessRQ'", new { lqueueAccessRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.WarnAndInfo(ex, new { MuteErrors, enumQueueNavigation, enumQueueDirection, pseudoCityCode, number, plus, lista, lqueueAccessRQRequest,  lqueueAccessRQResponse,  lrespuesta }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, enumQueueNavigation, enumQueueDirection, pseudoCityCode, number, plus, lista, lqueueAccessRQRequest, lqueueAccessRQResponse, lrespuesta }, CodigoSeguimiento);
