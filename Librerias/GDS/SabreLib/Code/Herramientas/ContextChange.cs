    ...
    public sealed class ContextChange : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
                                  ...
                                  out CE_Session sesion)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'ContextChangePortTypeChannel.ContextChangeRQ'", new { lcontextChangeRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lcontextChangeRQResponse = lservicio.ContextChangeRQ(lcontextChangeRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'ContextChangePortTypeChannel.ContextChangeRQ'", new { lcontextChangeRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, pseudo, lcontextChangeRQRequest, lcontextChangeRQResponse, lrespuesta }, CodigoSeguimiento);
