    ...
    public sealed class SessionClose : Common<Security, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
        ...
        public CE_Estatus Execute()
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'SessionClosePortTypeChannel.SessionCloseRQ'", new { lsessionCloseRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lsessionCloseRQResponse = lservicio.SessionCloseRQ(lsessionCloseRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'SessionClosePortTypeChannel.SessionCloseRQ'", new { lsessionCloseRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, lsessionCloseRQRequest, lsessionCloseRQResponse, lrespuesta }, CodigoSeguimiento);
