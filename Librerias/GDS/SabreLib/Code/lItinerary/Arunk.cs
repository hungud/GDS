    ...
    public sealed class Arunk : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
        ...
        public CE_Estatus Execute()
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'ARUNK_PortTypeChannel.ARUNK_RQ'", new { larunkRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    larunkRQResponse = lservicio.ARUNK_RQ(larunkRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'ARUNK_PortTypeChannel.ARUNK_RQ'", new { larunkRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, larunkRQRequest, larunkRQResponse, lrespuesta }, CodigoSeguimiento);
