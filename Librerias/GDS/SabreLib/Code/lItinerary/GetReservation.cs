        ...
        /// <returns></returns>
                                    ...
                                    out CE_ReservaHotel reservaHotel)
         {
             ...
             try
             {
                 ...
                 {
                     // registrando eventos
                     Bitacora.Current.DebugAndInfo("Por ejecutar 'GetReservationPortTypeChannel.GetReservationRQ'", new { lgetReservationOperationRequest }, CodigoSeguimiento);

                     // procesando solicitud
                     lgetReservationOperationResponse = lservicio.GetReservationOperation(lgetReservationOperationRequest);

                     // registrando eventos
                     Bitacora.Current.DebugAndInfo("Ejecutado 'GetReservationPortTypeChannel.GetReservationRQ'", new { lgetReservationOperationResponse }, CodigoSeguimiento);
             ...
             {
                 // registrando eventos
                 Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, pnr, areasTematicas, lgetReservationOperationRequest, lgetReservationOperationResponse, lrespuesta }, CodigoSeguimiento);
