    ...
    public sealed class DailySalesReport : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
                                                     ...
                                                     string date)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Por ejecutar 'DailySalesReportPortTypeChannel.DailySalesReportRQ'", new { ldailySalesReportRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    ldailySalesReportRQResponse = lservicio.DailySalesReportRQ(ldailySalesReportRQRequest);

                    // registrando eventos
                    Bitacora.Current.DebugAndInfo("Ejecutado 'DailySalesReportPortTypeChannel.DailySalesReportRQ'", new { ldailySalesReportRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.ErrorAndInfo(ex, new { MuteErrors, pseudoQuery, date, ldailySalesReportRQRequest, ldailySalesReportRQResponse, lrespuesta }, CodigoSeguimiento);
