...
namespace AmadeusLib.Utiles
{
    ...
    public sealed class WebServiceFileValueAmadeus<T> : IDisposable
        where T : class
    {
        // =============================
        // variables
        ...
        public WebServiceFileValueAmadeus(WebServiceAction name)
        {
            var ldocumentoXml = new XmlDocument();

            // cargando archivo
            ldocumentoXml.Load((Ambiente.ExecutionPath + Configuracion.WebServiceFileValueAmadeus));
