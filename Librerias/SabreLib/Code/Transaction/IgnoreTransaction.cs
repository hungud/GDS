    ...
    public sealed class IgnoreTransaction : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
        ...
        public CE_Estatus Execute()
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Por ejecutar 'IgnoreTransactionPortTypeChannel.IgnoreTransactionRQ'", null, new { lignoreTransactionRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lignoreTransactionRQResponse = lservicio.IgnoreTransactionRQ(lignoreTransactionRQRequest);

                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Ejecutado 'IgnoreTransactionPortTypeChannel.IgnoreTransactionRQ'", null, new { lignoreTransactionRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Error, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, lignoreTransactionRQRequest, lignoreTransactionRQResponse, lrespuesta }, CodigoSeguimiento);
