...
namespace SabreLib.Queue
{
    public sealed class QueueCount : Common<Security, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
        ...
        public void Execute()
        {
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Error, "ERROR ejecutando '.Execute'", ex, new { _signatureUser, Security, MessageHeader, command, lsabreCommandLLSRQ, lsabreCommandLLSRS }, CodigoSeguimiento);
