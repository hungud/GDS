    ...
    public sealed class DesignatePrinter : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
                                   ...
                                   string perfilImpresora)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Por ejecutar 'DesignatePrinterPortTypeChannel.DesignatePrinterRQ'", null, new { ldesignatePrinterRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    ldesignatePrinterRQResponse = lservicio.DesignatePrinterRQ(ldesignatePrinterRQRequest);

                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Ejecutado 'DesignatePrinterPortTypeChannel.DesignatePrinterRQ'", null, new { ldesignatePrinterRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Error, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, desfirmarImpresora, perfilImpresora, ldesignatePrinterRQRequest, ldesignatePrinterRQResponse, lrespuesta }, CodigoSeguimiento);
