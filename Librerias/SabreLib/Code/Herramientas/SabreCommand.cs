    ...
    public sealed class SabreCommand : Common<Security, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
        ...
        public CE_Estatus Execute(string comando)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Por ejecutar 'SabreCommandLLSPortTypeChannel.SabreCommandLLSRQ'", null, new { lsabreCommandLLSRQRequest1 }, CodigoSeguimiento);

                    // procesando solicitud
                    lsabreCommandLLSRQResponse = lservicio.SabreCommandLLSRQ(lsabreCommandLLSRQRequest1);

                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Ejecutado 'SabreCommandLLSPortTypeChannel.SabreCommandLLSRQ'", null, new { lsabreCommandLLSRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Error, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, comando, lsabreCommandLLSRQRequest1, lsabreCommandLLSRQResponse, lrespuesta }, CodigoSeguimiento);
