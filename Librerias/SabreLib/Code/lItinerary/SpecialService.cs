    ...
    public sealed class SpecialService : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service, MessageData>
    {
        ...
        private CE_Estatus Execute(RQ_AnadirServicioEspecial parametros)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Por ejecutar 'SpecialServicePortTypeChannel.SpecialServiceRQ'", null, new { lspecialServiceRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lspecialServiceRQResponse = lservicio.SpecialServiceRQ(lspecialServiceRQRequest);

                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Ejecutado 'SpecialServicePortTypeChannel.SpecialServiceRQ'", null, new { lspecialServiceRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Error, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, lspecialServiceRQRequest, lspecialServiceRQResponse, lrespuesta }, CodigoSeguimiento);
