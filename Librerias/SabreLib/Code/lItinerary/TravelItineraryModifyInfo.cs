    ...
    public sealed class TravelItineraryModifyInfo : Common<Security1, MessageHeader, SecurityUsernameToken, From, To, PartyId, Service1, MessageData>
    {
        ...
        public CE_Estatus Execute(RQ_ActualizarPasajeros parametros)
        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Por ejecutar 'TravelItineraryModifyInfoPortTypeChannel.TravelItineraryModifyInfoRQ'", null, new { ltravelItineraryModifyInfoRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    ltravelItineraryModifyInfoRQResponse = lservicio.TravelItineraryModifyInfoRQ(ltravelItineraryModifyInfoRQRequest);

                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Ejecutado 'TravelItineraryModifyInfoPortTypeChannel.TravelItineraryModifyInfoRQ'", null, new { ltravelItineraryModifyInfoRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Warn, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, parametros, ltravelItineraryModifyInfoRQRequest, ltravelItineraryModifyInfoRQResponse, lrespuesta }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Error, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, parametros, ltravelItineraryModifyInfoRQRequest, ltravelItineraryModifyInfoRQResponse, lrespuesta }, CodigoSeguimiento);
