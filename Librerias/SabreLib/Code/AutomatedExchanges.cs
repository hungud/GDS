        ...
        */
...

        {
            ...
            try
            {
                ...
                {
                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Por ejecutar 'AutomatedExchangesPortTypeChannel.AutomatedExchangesRQ'", null, new { lautomatedExchangesRQRequest }, CodigoSeguimiento);

                    // procesando solicitud
                    lautomatedExchangesRQResponse = lservicio.AutomatedExchangesRQ(lautomatedExchangesRQRequest);

                    // registrando eventos
                    Bitacora.Current.InfoAnd(PartnerLevel.Debug, "Ejecutado 'AutomatedExchangesPortTypeChannel.AutomatedExchangesRQ'", null, new { lautomatedExchangesRQResponse }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Warn, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, tipoOperacion, reserva, lautomatedExchangesRQRequest, lautomatedExchangesRQResponse, lrespuesta }, CodigoSeguimiento);
            ...
            {
                // registrando eventos
                Bitacora.Current.InfoAnd(PartnerLevel.Error, "ERROR ejecutando '.Execute'", ex, new { MuteErrors, tipoOperacion, reserva, lautomatedExchangesRQRequest, lautomatedExchangesRQResponse, lrespuesta }, CodigoSeguimiento);
