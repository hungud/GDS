// <copyright file="B2BWalletDetail.cs" company="Amadeus IT Group Colombia">   
...
namespace AmadeusLATAM.B2BWallet.Core.B2BWalletVerb
{
    ...
    /// <summary>
    /// Clase que permite realizar los llamados a los servicios necesarios para generar un detalle de datos de una tarjeta de crédito.
    /// </summary>
    public class B2BWalletDetail : IVerb
    {
        ...
        /// <summary>
        /// Metodo que centraliza la ejecución de peticiones que permiten generar un detalle de datos de una tarjeta de crédito.
        /// </summary>
        ...
        public EnvelopeRSModel Execute(EnvelopeRQModel request)
        {
            ...
            soapAction = GeneralUtility.GetValuesAnnotation<SoapActionModel>(AmadeusServiceEnum.PAY_GetVirtualCardDetails_2_0);
            ...
            if (lstValidator == null || lstValidator.Count() == 0)
            {
                ...
                amadeusService = new PAY_GetVirtualCardDetailsService(amadeusSession);
            ...
            message = new XDocument(
                ...
                select new XElement("Data",
                    ...
                    new XElement("Display", 
                        new XAttribute("Full", ConversionUtility.ConvertStringToBoolean(ConversionUtility.GetXAttributeFromXElement(xmlElement.Element("Display"), "Full", false.ToString())))
                    )
                )
            );
