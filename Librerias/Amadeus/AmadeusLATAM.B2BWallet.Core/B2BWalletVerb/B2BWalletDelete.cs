// <copyright file="B2BWalletDelete.cs" company="Amadeus IT Group Colombia">   
...
namespace AmadeusLATAM.B2BWallet.Core.B2BWalletVerb
{
    ...
    /// <summary>
    /// Clase que permite realizar los llamados a los servicios necesarios para eliminar una tarjeta de crédito.
    /// </summary>
    public class B2BWalletDelete : IVerb
    {
        ...
        /// <summary>
        /// Metodo que centraliza la ejecución de peticiones que permiten realizar la eliminación de una tarjeta de crédito.
        /// </summary>
        ...
        public EnvelopeRSModel Execute(EnvelopeRQModel request)
        {
            ...
            soapAction = GeneralUtility.GetValuesAnnotation<SoapActionModel>(AmadeusServiceEnum.PAY_DeleteVirtualCard_2_0);
            ...
            if (lstValidator == null || lstValidator.Count() == 0)
            {
                ...
                amadeusService = new PAY_DeleteVirtualCardService(amadeusSession);
        ...
        private List<string> ValidateRequest(ref XDocument message)
        {
            ...
            message = new XDocument(
                ...
                select new XElement("Data",
                    ...
                    new XElement("Comment", ConversionUtility.ConvertXElementToValue(xmlElement.Element("Comment")))
                )
            );
