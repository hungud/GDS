// <copyright file="PAY_GetVirtualCardDetailsService.cs" company="Amadeus IT Group Colombia">   
...
namespace AmadeusLATAM.B2BWallet.Core.B2BWalletService
{
    ...
    /// Clase concreta que integra la funcionalidad de generación de un detalle de tarjeta de credito virtual y la cual implementa de la factoria BaseService.
    public class PAY_GetVirtualCardDetailsService : BaseService
    {
        ...
        public PAY_GetVirtualCardDetailsService(SessionWSModel session) : base(session) { }
