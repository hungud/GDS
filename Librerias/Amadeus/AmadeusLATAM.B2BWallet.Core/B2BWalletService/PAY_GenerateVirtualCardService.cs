// <copyright file="PAY_GenerateVirtualCardService.cs" company="Amadeus IT Group Colombia">   
...
namespace AmadeusLATAM.B2BWallet.Core.B2BWalletService
{
    ...
    /// <summary>
    /// Clase concreta que integra la funcionalidad de generación de tarjetas de credito virtuales y la cual implementa de la factoria BaseService.
    /// </summary>
    public class PAY_GenerateVirtualCardService : BaseService
    {
        ...
        public PAY_GenerateVirtualCardService(SessionWSModel session) : base(session) { }
