// <copyright file="PAY_ListVirtualCardsService.cs" company="Amadeus IT Group Colombia">   
...
namespace AmadeusLATAM.B2BWallet.Core.B2BWalletService
{
    ...
    /// Clase concreta que integra la funcionalidad de listar las tarjetas de credito virtuales que cumplan ciertos criterios, ademas que implementa de la factoria BaseService.
    public class PAY_ListVirtualCardsService: BaseService
    {
        ...
        public PAY_ListVirtualCardsService(SessionWSModel session) : base(session) { }
